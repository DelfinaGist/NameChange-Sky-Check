...
Technologies used for this project: CSS, HTML, JAVE SCRIPT, API, AND REACT LIBRARY.
...
There were some unsolved problems making the app not function as I intended, but the user still could receive the weather temperature.

My goal is to add time and date to the app
